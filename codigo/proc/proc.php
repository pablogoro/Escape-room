...
if(isset($_POST['solucion1']) && strtolower($_POST['solucion1'])=='no creas que la única realidad es la que puedes ver'){
    session_start();
...
if((isset($_POST['enigma']) && strtolower($_POST['enigma'])=='tiempo') || (isset($_POST['pantalla1']) && isset($_POST['enigma']) && strtolower($_POST['enigma'])=='el tiempo')){
    session_start(); 
...
// logica 3 pantalla 4
 ...
 if (isset($_POST['paciencia']) && strtolower($_POST['paciencia'])=='no tengas demasiada prisa pero tampoco mucha paciencia'){
    session_start(); 
